...
// print_r($movieObject);
$latest=$movieObject->getAllLatestAll();
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link active " href="#"   aria-current="page" style="color:rgb(253, 252, 250);" >Latest</a>
          </li>
          <li class="nav-item">
...
<!-- its the actual content area -->
   <div class="content-area " >
    ...
    <div class="recent">
      <br>
      <h2 style="padding-left:2%;  font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;">Latest Reviews:</h2>
      <div class="container">
